...
//////////////////////////////////////////////////
    ...
    public function clear() {
        ...
        return $this->redirect('/pages/merchandise');
    }
    ...
    public function address() {
        ...
        if ($this->request->is('post')) {
            ...
            if($this->Order->validates()) {
				...
				$this->Session->setFlash('The form could not be saved. Please, try again', 'default', array('class' => 'callout alert'));
            }
        }
        if(!empty($shop['Order'])) {
