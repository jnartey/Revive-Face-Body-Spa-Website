...
$(document).ready(function() {
	...
	{
		filebrowserBrowseUrl : "<?php echo $this->Html->url(DS.'filemanager'.DS.'index.html', true); ?>",
		filebrowserImageBrowseUrl : "<?php echo $this->Html->url(DS.'filemanager'.DS.'browser'.DS.'default'.DS.'browser.html?Type=Image', true); ?>"
	});
});
</script>
</html>
