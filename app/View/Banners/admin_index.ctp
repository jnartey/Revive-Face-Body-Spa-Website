		...
		<table cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td class="actions">
						<?php 
							if($banner['Banner']['add_banner'] == 1){ echo $this->Html->link(__("Add Banner", true), array('controller'=> 'banners', 'action'=>'add', $banner['Banner']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny success')); }
							echo $this->Html->link(__("View", true), array('controller'=> 'banners', 'action'=>'view', $banner['Banner']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny primary')); 
							echo $this->Html->link(__("Edit", true), array('controller'=> 'banners', 'action'=>'edit', $banner['Banner']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny secondary'));
