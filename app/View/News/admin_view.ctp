<div class="row">
	<div class="columns admin-head">
		<div class="module yellow">
			<h2>
				<?php echo $current_page.substr($news['News']['title'], 0, strrpos(substr($news['News']['title'], 0, 30), ' '))."..."; ?> <a href="#"><?php echo $header; ?></a>
			</h2>
		</div>
	</div>
</div>
	...
	<div class="large-10 columns content">
		...
		<div class="large-12 columns">
			<?php 
					...
					if($news['News']['add_news'] == 1){
						echo $this->Html->link(__(("Add"), true), array('controller'=> 'news', 'action'=>'add', $news['News']['id'], 'admin' => true), array('escape' => false, 'class'=>'button small secondary')); 
					}
					...
					<tr>
						...
						<td class="actions">
							<?php 
								...
								if($data['News']['archive'] == 0){
									echo  $this->Form->postLink(__("Archive", true), array('controller'=>'news', 'action'=>'archive_news', $data['News']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny secondary'), sprintf(__('Are you sure you want to archive ~ '.$data['News']['title'], true), $data['News']['id']));
								}else{
									echo  $this->Form->postLink(__("Archived", true), array('controller'=>'news', 'action'=>'unarchive_news', $data['News']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny secondary'), sprintf(__('Are you sure you want to remove from archive ~ '.$data['News']['title'], true), $data['News']['id']));
								}
							?>
						</td>
					</tr><?php endforeach; ?>
