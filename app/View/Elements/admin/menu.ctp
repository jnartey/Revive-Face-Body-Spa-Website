	  ...
	  <section class="top-bar-section">
	    ...
	    <ul class="left">
			...
			<!-- <li>
	      	...
	      	<!-- <li>
	          <?php echo $this->Html->link(__(("Categories"), true), array('controller'=> 'categories', 'action'=>'index', 'admin' => true), array('escape' => false, 'class'=>'admin-panel fancybox.iframe')); ?>
			</li> -->
	      	<!-- <li>
	          <?php echo $this->Html->link(__(("Products Mods"), true), array('controller'=> 'productmods', 'action'=>'index', 'admin' => true), array('escape' => false, 'class'=>'admin-panel fancybox.iframe')); ?>
			 </li> -->
	      	<!-- <li>
	          <?php echo $this->Html->link(__(("Products"), true), array('controller'=> 'products', 'action'=>'index', 'admin' => true), array('escape' => false, 'class'=>'admin-panel fancybox.iframe')); ?>
			</li> -->
			<!-- <li>
			...
			<!-- <li>
	          <?php echo $this->Html->link(__(("Gallery"), true), array('controller'=> 'galleries', 'action'=>'index', 'admin' => true), array('escape' => false, 'class'=>'admin-panel fancybox.iframe')); ?>
			</li> -->
			<li>
