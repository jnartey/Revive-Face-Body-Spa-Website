...
<div class="large-12 columns header-m">
	<div class="title-bar" data-responsive-toggle="revive-menu" data-hide-for="large">
		<span class="phone-wrap">
			<span class="phone"><?php echo $phone['PageContent']['content'] ?></span>
		</span>
		<span class="social-media">
			<a class="fa fa-facebook fa-1x" href="https://www.facebook.com/revivefaceandbody" target="_blank"></a>
			<a class="fa fa-instagram fa-1x" href="https://www.instagram.com/revivefaceandbodyspa" target="_blank"></a>
		</span>
		<div class="title-bar-title">Menu</div>
	  	<button class="menu-icon dark" type="button" data-toggle="revive-menu"></button>
		<a class="logo" href="<?php echo $this->Html->url(DS, true); ?>">
			<?php echo $this->Html->image('logo.jpg', array('alt' => 'Revive Face & Body Spa')); ?>
		</a>
	</div>

	<div class="top-bar" id="revive-menu">
