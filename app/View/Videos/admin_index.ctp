			...
			?>
				<tr>
					...
					<td class="actions">
						...
						<?php echo $this->Form->postLink(__("Delete", true), array('controller'=> 'videos', 'action'=>'delete', $item['Video']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny alert'), sprintf(__('Are you sure you want to delete '.$item['Video']['name'].'?', true), $item['Video']['id'])); 
						if($item['Video']['featured'] == 1){
							echo '<a class="button tiny success" href="#">Featured</a>';
						}else{
							echo $this->Form->postLink(__("feature video", true), array('controller'=> 'videos', 'action'=>'featured', $item['Video']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny secondary'), sprintf(__('Are you sure you want to feature '.$item['Video']['name'].'?', true), $item['Video']['id']));
						}
