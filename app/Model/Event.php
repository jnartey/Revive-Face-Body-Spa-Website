	...
	public function beforeSave($options = array()) {
	        if (!empty($this->data[$this->alias]['title']) && empty($this->data[$this->alias]['slug'])) {
	            if (!empty($this->data[$this->alias][$this->primaryKey])) {
	                $this->data[$this->alias]['slug'] = $this->generateSlug($this->data[$this->alias]['bane'], $this->data['Event'][$this->primaryKey]);
	            } else {
	    ...
	    'MeioUpload.MeioUpload' => array(
	        'event_image' => array(
	            ...
	            'zoomCrop' => false,  
	           	'thumbnails' => true ,
				'thumbsizes' => array(
					'large'  => array('width'=>1024, 'height'=>600),
					'small'  => array('width'=>371, 'height'=>273, 'thumbnailQuality' => 100, 'zoomCrop' => true),
					'thumbnail'  => array('width'=>371, 'height'=>273, 'thumbnailQuality' => 100, 'zoomCrop' => true)
				),
