...
class SitemapBehavior extends ModelBehavior {
	...
	public function buildUrlC(Model $Model, $primaryKey) {
		return Router::url(array('plugin' => NULL, 'controller' => 'pages', 'action' => 'collection', $primaryKey), TRUE);
	}
	
	public function buildUrlP(Model $Model, $primaryKey) {
		return Router::url(array('plugin' => NULL, 'controller' => 'pages', 'action' => 'collections', $primaryKey), TRUE);
	}
